...
//            if (nelemstencil == 0 && comm->me == 166) 
//              printf("Build_stencil step = %d me = %d ijk = %d %d %d elems = %d %d %d melembin = %d %d %d ibinstyle = %d\n",update->ntimestep,
//                  comm->me,i,j,k
//                  ,elemsx,elemsy,elemsz
//                  ,nb->melembinx
//                  ,nb->melembiny
//                  ,nb->melembinz,nb->istyle);
