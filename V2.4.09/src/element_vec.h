...
class ElementVec : protected Pointers {
 public:
  ...
  int size_data_cluster;               // number of values in Element Clusters line
  ...
  int **nintgs;     // number of integration points along each direction
  ...
  virtual void wedge2wedge(int, int, int) = 0;
  virtual void wedge2trapeprism(int, int, int, int) = 0;
  virtual void pyr2tet(int, int, int, int) = 0;
  //virtual int split_element(int, int, double, int, int, double *) = 0;
  virtual int split_element(int **, int) = 0;
  virtual int check_split_element(int, int, int, double, int *, int &, int) = 0;
  virtual int check_split_element(int, double [3], double [3], double, double, int *, int &) = 0;
  ...
  virtual void create_pass_on_atom(int, int, int, tagint) = 0;
  virtual void update_surface_plane() = 0;
  ...
  virtual void data_node_reference(int, char **, int, double *) = 0;
  ...
  virtual void pack_element_cluster_data(double **) = 0;
  virtual void write_element_cluster_data(FILE *, int, double **) = 0;
  ...
  virtual void pack_node_tecplot(double **) = 0;
  virtual void pack_node_tecplot_binary(double *, int) = 0;
  virtual void write_node_tecplot(FILE *, int, double **) = 0;
  virtual void pack_node_connect_tecplot(int *) = 0;
  virtual void write_node_connect_tecplot(FILE *, int, int *) = 0;
  
  // functions for write_data_adrian command
  
  virtual void pack_element_data_adrian(double **) = 0;
  virtual void write_element_data_adrian(FILE *, int, double **) = 0;
 ...
 protected:
  ...
  int nmaxintg;                        // local copy of element->nmaxintg
  bigint nmaxintpl;                    // local copy of element->nmaxintpl
