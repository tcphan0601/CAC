  ...
  : memory(mem), atom(atm), element(elem), error(err)
{
  ...
  namax = 0;
  nemax = 0;
  atomrho = atomrho0 = atomrho1 = atomrho2 = atomrho3 = atomfrhop = NULL;
  atomgamma = atomdgamma1 = atomdgamma2 = atomdgamma3 = atomarho2b = NULL;
  atomarho1 = atomarho2 = atomarho3 = atomarho3b = atomt_ave = atomtsq_ave = NULL;
  noderho = noderho0 = noderho1 = noderho2 = noderho3 = nodefrhop = NULL;
  nodegamma = nodedgamma1 = nodedgamma2 = nodedgamma3 = nodearho2b = NULL;
  nodearho1 = nodearho2 = nodearho3 = nodearho3b = nodet_ave = nodetsq_ave = NULL;
