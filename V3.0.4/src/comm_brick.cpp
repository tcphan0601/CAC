...
void CommBrick::setup_borders()
{
  ...
  cutghost[0] = MAX(cut, cutghostuser[0]);
  cutghost[1] = MAX(cut, cutghostuser[1]);
  cutghost[2] = MAX(cut, cutghostuser[2]);
  ...
  if (triclinic == 0) {
    ...
    cutghost[3] = cutghost[4] = cutghost[5] = cut;
    double extra_cut;
    ...
    cutghost[0] = cutghost[3] = cut * length0;
    cutghost[1] = cutghost[4] = cut * length1;
    cutghost[2] = cutghost[5] = cut * length2;
