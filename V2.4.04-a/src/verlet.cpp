...
//  if (comm->me == 0) fprintf(stdout,"Test 0 pair_compute_flag = %d\n",pair_compute_flag);
  if (pair_compute_flag) force->pair->compute(eflag,vflag);
  else if (force->pair) force->pair->compute_dummy(eflag,vflag);
//  if (comm->me == 0) fprintf(stdout,"Test 1\n");
  modify->setup_pre_reverse(eflag,vflag);
//  if (comm->me == 0) fprintf(stdout,"Test 2\n");
  if (force->newton) comm->reverse_comm();
//  if (comm->me == 0) fprintf(stdout,"Test 3\n");
  modify->setup(vflag);
//  if (comm->me == 0) fprintf(stdout,"Test 4\n");
