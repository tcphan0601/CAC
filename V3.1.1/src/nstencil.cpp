...
NStencil::NStencil(CAC *cac) : Pointers(cac)
{
  ...
  natomstencil = nelemstencil = 0;
  xyzflag = 0;
  maxatomstencil = maxatomstencil_multi = 0;
  atomstencil = nullptr;
  atomstencilxyz = nullptr;
  natomstencil_multi = nullptr;
  atomstencil_multi = nullptr;
  atomdistsq_multi = nullptr;

  maxelemstencil = maxelemstencil_multi = 0;
  elemstencil = nullptr;
  elemstencilxyz = nullptr;
  nelemstencil_multi = nullptr;
  elemstencil_multi = nullptr;
  elemdistsq_multi = nullptr;
...
void NStencil::create_setup()
{
  ...
  // double check with element->nodex_lamda_flag to ensure nodex is in lamda coords and convert back
  
  int nodex_lamda_flag = element->nodex_lamda_flag;
    if (nodex_lamda_flag) 
    ...
    if (neighstyle == Neighbor::BIN) {
      ...
      if (maxatomstencil_multi == 0) {
        ...
        for (i = 1; i <= n; i++) {
          ...
          atomstencil_multi[i] = nullptr;
          atomdistsq_multi[i] = nullptr;
        }
      }
    ...
    if (neighstyle == Neighbor::BIN) {
      ...
      if (maxelemstencil_multi == 0) {
        ...
        for (i = 1; i <= n; i++) {
          ...
          elemstencil_multi[i] = nullptr;
          elemdistsq_multi[i] = nullptr;
        }
      }
...
/*  ----------------------------------------------------------------------
    ...
    always return positive value of distance
    -------------------------------------------------------------------------  */
