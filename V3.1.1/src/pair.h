...
class Pair : protected Pointers {
 ...
 public:
  ...
  double *eatom, **vatom, **cvatom;         // accumulated per-atom energy/virial
  double ***enode, ****vnode, ****cvnode;       // accumulated per-node energy/virial
 ...
 protected:
  ...
  int maxeelem, maxvelem, maxcvelem;
