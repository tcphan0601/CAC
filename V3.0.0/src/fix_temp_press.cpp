...
void FixTempPress::post_force(int vflag)
{
  ...
  pvalue_c = tvalue/2.0 * 3.0 * boltz * inv_volume * 2 * (element->nucells - element->nnodes);  
      ...
      if (emask[i] & groupbit) {
        ...
        for (j = 0; j < nsurface[element_shape_ids[ietype]]; j++) {
          for (ibasis = 0; ibasis < apc[ietype]; ibasis++) {
            ...
            if (num_node == 3) {
              sub3(nodex[i][ibasis][surface_node[0]], nodex[i][ibasis][surface_node[1]], v1);
              sub3(nodex[i][ibasis][surface_node[2]], nodex[i][ibasis][surface_node[1]], v2);
              cross3(v1, v2, v);
              ...
              sub3(nodex[i][ibasis][surface_node[2]], nodex[i][ibasis][surface_node[1]], v2);
              cross3(v1, v2, v);
              surface_area = len3(v)/4.0;
              sub3(nodex[i][ibasis][surface_node[0]], nodex[i][ibasis][surface_node[3]], v1);
              sub3(nodex[i][ibasis][surface_node[2]], nodex[i][ibasis][surface_node[3]], v2);
              cross3(v1, v2, v);
              surface_area += len3(v)/4.0;
              sub3(nodex[i][ibasis][surface_node[1]], nodex[i][ibasis][surface_node[0]], v1);
              sub3(nodex[i][ibasis][surface_node[3]], nodex[i][ibasis][surface_node[0]], v2);
              cross3(v1, v2, v);
              surface_area += len3(v)/4.0;
              sub3(nodex[i][ibasis][surface_node[1]], nodex[i][ibasis][surface_node[2]], v1);
              sub3(nodex[i][ibasis][surface_node[3]], nodex[i][ibasis][surface_node[2]], v2);
              cross3(v1, v2, v);
              surface_area += len3(v)/4.0;
            ...
            for (k = 0; k < num_node; k++) {
              ...
              p2 = (k + 1) % num_node;
              p3 = (k + 2) % num_node;
              sub3(nodex[i][ibasis][surface_node[p3]], nodex[i][ibasis][surface_node[p2]], v1);
              sub3(nodex[i][ibasis][surface_node[p1]], nodex[i][ibasis][surface_node[p2]], v2);
              cross3(v1, v2, v);
              norm3(v);
            ...
            for (k = 0; k < num_node; k++) {
              if (srand_flag) {
                if (xstyle) nodef[i][ibasis][surface_node[k]][shear_direc - 1] += vec[shear_direc - 1];
              }  else {
                if (xstyle) nodef[i][ibasis][surface_node[k]][0] += vec[0];
                if (xstyle) nodef[i][ibasis][surface_node[k]][1] += vec[1];
                if (xstyle) nodef[i][ibasis][surface_node[k]][2] += vec[2];
              }
              dist[0] = nodex[i][ibasis][surface_node[k]][0] - ex[i][0];
              dist[1] = nodex[i][ibasis][surface_node[k]][1] - ex[i][1];
              dist[2] = nodex[i][ibasis][surface_node[k]][2] - ex[i][2];
