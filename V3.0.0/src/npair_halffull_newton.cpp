  ...
  for (ii = 0; ii < inum_full; ii++) {
    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      // j is virtual atom
        ...
        // skip half if i and j are both gauss points
        
        if (iindex >= 0 && jgcell >= 0) {
          jnode = g2n[jetype][jgcell];
          if (inode >= 0 && jnode >= 0) jindex = jnode;
          else if (igcell >= 0 && jgcell >= 0) jindex = jgcell;
          else if (iucell >= 0) jindex = jucell;
          jindex = jindex * japc + jbasis;
    ...
    //if (n == 0) {
    //  if (ii < ainum_full) ainum--;
    //  else if (ii < ainum_full + ninum_full) ninum--;
    //  else if (ii < ainum_full + ninum_full + ginum_full) ginum--;
    //  else vinum--;
    //  continue;
    //}
