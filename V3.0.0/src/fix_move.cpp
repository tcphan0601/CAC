...
FixMove::FixMove(CAC *cac, int narg, char **arg) :
  ...
  xoriginal(NULL), nodexoriginal(NULL), /*  toriginal(NULL), qoriginal(NULL),  */
  displace(NULL), nodedisplace(NULL), 
  velocity(NULL), nodevelocity(NULL)
{
