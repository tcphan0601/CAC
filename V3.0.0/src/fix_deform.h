...
#ifndef CAC_FIX_DEFORM_H
#define CAC_FIX_DEFORM_H
...
class FixDeform : public Fix {
 ...
 protected:
  ...
  class IrregularComm *irregular;  // for migrating atoms after box flips
...
specified.  This is because CAC cannot determine if the yz setting
