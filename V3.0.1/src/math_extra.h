...
#ifndef CAC_MATH_EXTRA_H
#define CAC_MATH_EXTRA_H
...
namespace MathExtra {
  ...
  inline bigint sum_nsq(int n);
  inline bigint sum_octahedron(int n);
  inline bigint sum_tetrahedron(int n);
  inline bigint sum_pyramid(int n);
  inline bigint sum_triangle(int n);

  // 3 vector operations

  inline void copy3(const double *v, double *ans);
  inline void zero3(double *v);
  inline void set3(double *v, double value);
  ...
  inline double len3(const double vx, const double vy, const double vz);
  ...
  // polar decomposition from deformation gradient to rotation and stretch tensors
   
  double matrix_determinant_3x3(double * A);
...
inline bigint MathExtra::sum_nsq(int n)
{
  bigint bn = n;
  return bn * (bn+1) * (2 * bn+1)/6;
} 

/*  ----------------------------------------------------------------------
   sum of points in a pyramid size n
   -------------------------------------------------------------------------  */

inline bigint MathExtra::sum_pyramid(int n)
{
  bigint bn = n;
  return bn * (bn+1) * (2 * bn+1)/6;
} 
...
/*  ----------------------------------------------------------------------
   sum of points in a octahedron size n
   -------------------------------------------------------------------------  */

inline bigint MathExtra::sum_octahedron(int n)
{
  bigint bn = n;
  return bn * (2 * bn * bn+1)/3;
}

/*  ----------------------------------------------------------------------
   sum of points in a tetrahedron size n
   -------------------------------------------------------------------------  */

inline bigint MathExtra::sum_tetrahedron(int n)
{
  bigint bn = n;
  return bn * (bn+1) * (bn+2)/6;
}
...
inline bigint MathExtra::sum_triangle(int n)
{
  bigint bn = n;
  return bn * (bn+1)/2;
}
...
/*  ----------------------------------------------------------------------
   set vector equal to some value
   -------------------------------------------------------------------------  */

inline void MathExtra::set3(double *v, double value)
{
  v[0] = value;
  v[1] = value;
  v[2] = value;
...
inline double MathExtra::norm3(double *v)
{
...
/*  ----------------------------------------------------------------------
   length of vector v with 3 components
   -------------------------------------------------------------------------  */

inline double MathExtra::len3(const double vx, const double vy, const double vz)
{
