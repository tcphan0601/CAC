...
void CommTiled::init_buffers()
{
  ...
  overlap_sendnum = NULL;
  overlap_recvnum = NULL;
  overlap_maxsendlist = NULL;
  overlap_firstrecv = NULL;
  overlap_sendlist = NULL;
...
void CommTiled::setup_borders() 
{
  ...
  if (layout != Comm::LAYOUT_TILED) {
    ...
    if (comm->me == 0 && element->nelements) {
  ...
  for (int ix = 0; ix < 3; ix ++) {
    for (int iy = 0; iy < 3; iy ++) {
      for (int iz = 0; iz < 3; iz ++) {
        ...
        if (one) (this->*box_drop)(0, lo1, hi1, NULL, indexme, 1);
