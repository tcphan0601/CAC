...
namespace NeighConst {
  ...
  static const int NP_INTG          = 1<<10;
  static const int NP_INTPL         = 1<<11;
  static const int NP_INTPL_OUTER   = 1<<12;

  // newton setting
  
  static const int NP_NEWTON        = 1<<13;
  static const int NP_NEWTOFF       = 1<<14;

  // neighborlist for ghost
  
  static const int NP_GHOST         = 1<<15;

  // threebody flag: neighborlist for interpolated atoms neighbor

  static const int NP_THREEBODY     = 1<<16;

  // a copy from another list
  
  static const int NP_COPY          = 1<<17;

  // perform neighbor sorting

  static const int NP_SORT          = 1<<18;

  // neighbor list only for specific group
  
  static const int NP_GROUP         = 1<<19;

  // neighbor list exclude inner interpolated atoms
  
  static const int NP_NOINNER       = 1<<20;
}
