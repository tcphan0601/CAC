...
namespace MathExtra {
  ...
  inline int sum_nsq(int n);
  inline int sum_octahedron(int n);
  inline int sum_tetrahedron(int n);
  inline int sum_pyramid(int n);
  inline int sum_triangle(int n);
...
inline int MathExtra::sum_nsq(int n)
{
...
inline int MathExtra::sum_pyramid(int n)
{
  return n*(n+1)*(2*n+1)/6;
} 
...
inline int MathExtra::sum_octahedron(int n)
{
  return n*(2*n*n+1)/3;
}
...
inline int MathExtra::sum_tetrahedron(int n)
{
  return n*(n+1)*(n+2)/6;
}
...
inline int MathExtra::sum_triangle(int n)
{
  return n*(n+1)/2;
}
