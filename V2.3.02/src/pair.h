...
class Pair : protected Pointers {
 ...
 public:
  ...
  virtual void pair_a2a(int, int, double *) = 0;
  virtual void pair_a2ia(int, int, int, double *, double *) = 0;
  virtual void pair_ia2ia(int, int, double *, int, int, double *, double *) = 0;
 ...
 protected:
  ...
  void atom_v_tally(int, double, double, double, double);
  void node_v_tally(int, int, double, double, double, double, double);
