...
int Input::execute_command()
{
  ...
  if (!strcmp(command,"clear")) {
  ...
  } else if (!strcmp(command,"add_atoms")) {
    add_atoms();
  } else if (!strcmp(command,"add_etype")) {
    add_etype();
  } else if (!strcmp(command,"atom_style")) {
    atom_style();
  } else if (!strcmp(command,"boundary")) {
    boundary();
  } else if (!strcmp(command,"box")) {
    box();
  } else if (!strcmp(command,"comm_modify")) {
    comm_modify();
  } else if (!strcmp(command,"comm_style")) {
    comm_style();
  } else if (!strcmp(command,"compute")) {
    compute();
    ...
    dump_modify();
  } else if (!strcmp(command,"element_modify")) {
    element_modify();
  } else if (!strcmp(command,"element_style")) {
    element_style(); 
  } else if (!strcmp(command,"fix")) {
    fix();
  } else if (!strcmp(command,"group")) {
    group_command();
  } else if (!strcmp(command,"modify_elements")) {
    modify_elements();
  } else if (!strcmp(command,"neighbor")) {
    neighbor_command();
  } else if (!strcmp(command,"neigh_modify")) {
    neigh_modify();
  } else if (!strcmp(command,"newton")) {
    newton();
  } else if (!strcmp(command,"region")) {
    region();
  } else if (!strcmp(command,"reset_timestep")) {
    reset_timestep();
    ...
    processors();
  } else if (!strcmp(command,"thermo")) {
    thermo();
  } else if (!strcmp(command,"thermo_style")) {
    thermo_style();
  } else if (!strcmp(command,"thermo_modify")) {
    thermo_modify();
  } else if (!strcmp(command,"timestep")) {
    timestep();
  } else if (!strcmp(command,"uncompute")) {
    uncompute();
  } else if (!strcmp(command,"undump")) {
    undump();
  } else if (!strcmp(command,"unfix")) {
    unfix();
...
void Input::modify_elements()
{
  element->modify_elements(narg,arg);
}
