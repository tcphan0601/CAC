...
class ElementVec : protected Pointers {
 public:
  ...
  int size_data_node;                  // number of values in Node line
  int size_data_vel;                   // number of values in Node Velocity line

  // for write_dat command
  
  int size_dat_node;                   // number of values in Coarse Grain line in write_dat file
  int size_dat_node_connect;           // number of values in Node Connectivity line in write_dat file
