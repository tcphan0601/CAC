...
WriteDat::WriteDat(CAC *cac) : Pointers(cac)
{
...
void WriteDat::command(int narg, char **arg)
{
...
void WriteDat::atoms()
{
  ...
  if (me == 0) {
    ...
    fprintf(fp,"\"x\", \"y\", \"z\", \"vx\", \"vy\", \"vz\", \"fx\", \"fy\", \"fz\"");
...
void WriteDat::nodes()
{
  ...
  if (me == 0) {
    ...
    bigint nnodes = nelements*element->npe;
