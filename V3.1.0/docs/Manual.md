...
-   For cutoff, put "adaptive" for adaptive CNA 
...
-   structure id list:
        ...
        other: 0
        Cubic diamond: 5
        Cubic diamond (1st neighbor): 3
        Cubic diamond (2nd neighbor): 1
        Hexagonal diamond: 6
        Hexagonal diamond (1st neighbor): 4
        Hexagonal diamond (2st neighbor): 2

-   if an atom is both 1st/2nd neighbor to a cubic diamond atom and a hexagonal
    diamond atom,
    it will be a hexagonal diamond 1st/2nd neighbor
...
-   NOTE: group-ID is ignored for dislocation/multidisl style
...
-   style = tecplot or atom or cna/atom or ids/atom or stress/mech
    -   tecplot: output .dat/.plt file for Tecplot (require TECPLOT package installed)
