...
namespace NeighConst {
  ...
  // contain neighbor list for atoms, elements, integration points, and/or interpolated atoms
  
  static const int NP_ATOM          = 1<<7;
  static const int NP_ELEM          = 1<<8;
  static const int NP_INTG          = 1<<9;
  static const int NP_INTPL         = 1<<10;

  // newton setting
  
  static const int NP_NEWTON        = 1<<11;
  static const int NP_NEWTOFF       = 1<<12;

  // neighborlist for ghost
  
  static const int NP_GHOST         = 1<<13;

  // threebody flag: neighborlist for interpolated atoms neighbor

  static const int NP_THREEBODY     = 1<<14;

  // a copy from another list
  
  static const int NP_COPY          = 1<<15;

  // perform neighbor sorting

  static const int NP_SORT          = 1<<16;
}
...
This is a current restriction within CAC.
