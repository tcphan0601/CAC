...
class ElementVec : protected Pointers {
 public:
  ...
  virtual void add_requested_etype() = 0;
  virtual void request_new_etype(int *) = 0;
  virtual int find_etype(int *) = 0;
  ...
  virtual int check_split_elem(int, int, int, int &, int &) = 0;
  virtual void update_element_bound_box() = 0;
  ...
  virtual void pack_element_data_elem(double **, tagint) = 0;
  virtual void pack_element_vel_data_elem(double **, tagint) = 0;
  virtual void pack_node_data_elem(double **, tagint) = 0;
  ...
  virtual void pack_node_connect_tecplot(double **) = 0;
  virtual void write_node_connect_tecplot(FILE *, int, double **) = 0;
