// define integer data types used by CAC and associated size limits
...
// MPI_CAC_BIGINT = MPI data type corresponding to a bigint

#ifndef CAC_CACTYPE_H
#define CAC_CACTYPE_H
...
#if !defined(CAC_SMALLSMALL) && !defined(CAC_BIGBIG) && !defined(CAC_SMALLBIG)
#define CAC_SMALLBIG
#endif

// allow user override of LONGLONG to LONG, necessary for some machines/MPI

#ifdef CAC_LONGLONG_TO_LONG
...
#define MPI_CAC_TAGINT MPI_INT
#define MPI_CAC_BIGINT MPI_LL
...
// settings to enable CAC to build under Windows
