...
RegPrism::RegPrism(CAC *cac, int narg, char **arg) : Region(cac, narg, arg)
{
  ...
  xy = xscale*universe->numeric(FLERR,arg[8]);
  xz = xscale*universe->numeric(FLERR,arg[9]);
  yz = yscale*universe->numeric(FLERR,arg[10]);
