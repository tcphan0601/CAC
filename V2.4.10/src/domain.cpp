    ...
    if (nonperiodic == 2) {
      ...
      for (int i = 0; i < nlocal; i++) 
        for (int j = 0; j < npe[etype[i]]; j++) {
          extent[0][0] = MIN(extent[0][0],nodex[i][j][0]);
          extent[0][1] = MAX(extent[0][1],nodex[i][j][0]);
          extent[1][0] = MIN(extent[1][0],nodex[i][j][1]);
          extent[1][1] = MAX(extent[1][1],nodex[i][j][1]);
          extent[2][0] = MIN(extent[2][0],nodex[i][j][2]);
          extent[2][1] = MAX(extent[2][1],nodex[i][j][2]);
        } 
...
void Domain::remap(double *x, double **nodex, imageint &image, int npe)
{
  double *lo,*hi,*period,*coord;
...
void Domain::remap(double *x, double **nodex, int npe)
{
  double *lo,*hi,*period,*coord;
  double lamda[3],del[3];
  del[0] = -x[0];
...
void Domain::unmap(double *x, double **nodex, imageint image, int inpe)
{
  int xbox = (image & IMGMASK) - IMGMAX;
  int ybox = (image >> IMGBITS & IMGMASK) - IMGMAX;
  int zbox = (image >> IMG2BITS) - IMGMAX;
...
void Domain::lamda2nodex(int n, double ***nodex)
{
  ...
  for (int i = 0; i < n; i++) 
    for (int j = 0; j < npe[etype[i]]; j++) {
      nodex[i][j][0] = h[0]*nodex[i][j][0] + h[5]*nodex[i][j][1] + h[4]*nodex[i][j][2] + boxlo[0];
      nodex[i][j][1] = h[1]*nodex[i][j][1] + h[3]*nodex[i][j][2] + boxlo[1];
      nodex[i][j][2] = h[2]*nodex[i][j][2] + boxlo[2];
    }
}
...
void Domain::nodex2lamda(int n, double ***nodex)
{
  ...
  for (int i = 0; i < n; i++) 
    for (int j = 0; j < npe[etype[i]]; j++) {
      delta[0] = nodex[i][j][0] - boxlo[0];
      delta[1] = nodex[i][j][1] - boxlo[1];
      delta[2] = nodex[i][j][2] - boxlo[2];

      nodex[i][j][0] = h_inv[0]*delta[0] + h_inv[5]*delta[1] + h_inv[4]*delta[2];
      nodex[i][j][1] = h_inv[1]*delta[1] + h_inv[3]*delta[2];
      nodex[i][j][2] = h_inv[2]*delta[2];
    }
}
...
void Domain::nodex2lamda_current(int n, double ***nodex)
{
  ...
  for (int i = 0; i < n; i++) 
    for (int j = 0; j < npe[etype[i]]; j++) {
      delta[0] = nodex[i][j][0] - boxlo_current[0];
      delta[1] = nodex[i][j][1] - boxlo_current[1];
      delta[2] = nodex[i][j][2] - boxlo_current[2];

      nodex[i][j][0] = h_current_inv[0]*delta[0] + h_current_inv[5]*delta[1] + h_current_inv[4]*delta[2];
      nodex[i][j][1] = h_current_inv[1]*delta[1] + h_current_inv[3]*delta[2];
      nodex[i][j][2] = h_current_inv[2]*delta[2];
    }
}
/* ----------------------------------------------------------------------
...
void Domain::lamda2nodex_current(int n, double ***nodex)
{
  ...
  for (int i = 0; i < n; i++) 
    for (int j = 0; j < npe[etype[i]]; j++) {
      nodex[i][j][0] = h_current[0]*nodex[i][j][0] + h_current[5]*nodex[i][j][1] + h_current[4]*nodex[i][j][2] + boxlo_current[0];
      nodex[i][j][1] = h_current[1]*nodex[i][j][1] + h_current[3]*nodex[i][j][2] + boxlo_current[1];
      nodex[i][j][2] = h_current[2]*nodex[i][j][2] + boxlo_current[2];
    }
}
...
void Domain::remap_current(double *x, double **nodex, int npe)
{
  double *lo,*hi,*period,*coord;
  double lamda[3],del[3];
