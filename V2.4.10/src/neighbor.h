...
class Neighbor : protected Pointers {
 ...
 public:
  ...
  double **innercutneighsq;        // neighbor cutneigh sq for each type pair in the inner layer (of the list)
...
namespace NeighConst {
  ...
  static const int NP_HALFFULL          = 1<<5;

  // orthogonal or triclinic box

  static const int NP_ORTHO         = 1<<6;
  static const int NP_TRI           = 1<<7;

  // contain neighbor list for atoms, elements, integration points, and/or interpolated atoms (or outers)
  
  static const int NP_ATOM          = 1<<8;
  static const int NP_ATOMONLY      = 1<<9;
  static const int NP_ELEM          = 1<<10;
  static const int NP_NODE          = 1<<11;
  static const int NP_INTG          = 1<<12;
  static const int NP_INTPL         = 1<<13;
  static const int NP_INTPL_OUTER   = 1<<14;

  // newton setting
  
  static const int NP_NEWTON        = 1<<15;
  static const int NP_NEWTOFF       = 1<<16;

  // neighborlist for ghost
  
  static const int NP_GHOST         = 1<<17;

  // threebody flag: neighborlist for interpolated atoms neighbor

  static const int NP_THREEBODY     = 1<<18;

  // a copy from another list
  
  static const int NP_COPY          = 1<<19;

  // perform neighbor sorting

  static const int NP_SORT          = 1<<20;

  // neighbor list only for specific group
  
  static const int NP_GROUP         = 1<<21;

  // neighbor list exclude inner interpolated atoms
  
  static const int NP_NOINNER       = 1<<22;

  // neighbor list contains additional outer neighbor list
  
  static const int NP_DOUBLE        = 1<<23;
}
