...
class Pair : protected Pointers {
 ...
 public:
  ...
  int double_neighbor_layers;
  double **innercutsq;           // cutoff sq for each atom pair, 
                                 //actual force cutoff for pair style that require double layers of neighbor list, the outer cutoff is cutsq
                                 //
