...
//  int copymode;                    // 1 if this is a Kokkos on-device copy
  ...
  int agnum;                  // # of ghost atoms neighbors are stored for
  ...
  int *e2nlist;               // local indices of first node point of element I
  ...
  int *numneighe2a;           // # of J atom neighbors for each
  ...
  int *numneighn2ia;          // # of J interpolated atom neighbors
                              // for each I node
                              // (size of array should be
                              // # of integration points: iinum)
                              
  int *numneighn2a;           // # of J "real" atom neighbors 
                              // for each I node
                              // (size of array should be 
                              // # of integration points: iinum)
  ...
  int **firstneighn2a;        // ptr to array (size numneighi2a) 
                              // of J atom index of each I node

  int **firstneighn2ia;       // ptr to array (size numneighi2ia)
                              // of J interpolated atom's parent 
                              // element index of each I node

  int **firstneighn2ia_index; // ptr to array (size numneighi2ia) 
                              // of J interpolated atom's index 
                              // within its parent element of each 
                              // I integration point (iinum pointers)
  ...
  int **firstneighia2ia;      // ptr to array (size numneighi2ia)
                              // of J interpolated atom's parent 
                              // element index of each I interpolated
  ...
  int *numneigha2a_outer;           // # of J atom neighbors for each 
                              // I atom (size of array should
                              // be # of atoms: ainum)
                              
  int *numneigha2ia_outer;          // # of J interpolated atom neighbors
                              // for each I atom (size of array
                              // should be # of atoms: ainum)
                              
  int *numneighi2ia_outer;          // # of J interpolated atom neighbors
                              // for each I integration point 
                              // (size of array should be
                              // # of integration points: iinum)
                              
  int *numneighi2a_outer;           // # of J "real" atom neighbors 
                              // for each I integration point 
                              // (size of array should be 
                              // # of integration points: iinum)
                              
 
  int **firstneigha2a_outer;        // ptr to array (size numneigha2a) 
                              // of J atom index of each I atom 
                              // (ainum pointers)
                              
  int **firstneigha2ia_outer;       // ptr to array (size numneigha2ia)
                              // of J interpolated point's parent
                              // element index of each I atom 
                              // (ainum pointers)
  
  int **firstneigha2ia_index_outer; // ptr to array (size numneigha2ia) 
                              // of J interpolated point's index 
                              // within its parent elelemt of 
                              // each I atom (ainum pointers)
  
  int **firstneighi2a_outer;        // ptr to array (size numneighi2a) 
                              // of J atom index of each I 
                              // integration point (iinum pointers)

  int **firstneighi2ia_outer;       // ptr to array (size numneighi2ia)
                              // of J interpolated atom's parent 
                              // element index of each I integration
                              // point (iinum pointers)
                              
  int **firstneighi2ia_index_outer; // ptr to array (size numneighi2ia) 
                              // of J interpolated atom's index 
                              // within its parent element of each 
                              // I integration point (iinum pointers)
  MyPage<int> *a2a_outer_page;           // pages of atom to atom neighbor indices
  MyPage<int> *a2ia_outer_page;          // pages of atom to interpolated atom
                                  // neighbor's parent element indices
  MyPage<int> *a2ia_index_outer_page;    // pages of atom to interpolated atom 
                                  // neighbor's indices within its parent 
                                  // element
  MyPage<int> *i2a_outer_page;           // pages of integration point to atom 
                                  // neighbor indices
  MyPage<int> *i2ia_outer_page;          // pages of integration point to interpolated
                                  // atom neighbor's parent element indices
  MyPage<int> *i2ia_index_outer_page;    // pages of integration point to 
  ...
  int maxnode;                    // size of allocated per-node arrays
  ...
  MyPage<int> *a2ia_indexpage;    // pages of atom to interpolated atom 
                                  // neighbor's indices within its parent 
                                  // element
  MyPage<int> *e2apage;           // pages of element to atom neighbor indices
  ...
  MyPage<int> *i2ia_indexpage;    // pages of integration point to 
                                  // interpolated atom neighbor's indices 
                                  // within its parent element
  MyPage<int> *n2apage;           // pages of node to atom 
                                  // neighbor indices
  MyPage<int> *n2iapage;          // pages of node to interpolated
                                  // atom neighbor's parent element indices
  MyPage<int> *n2ia_indexpage;    // pages of node point to 
                                  // interpolated atom neighbor's indices 
                                  // within its parent element
...
*/
  ...
  void grow_node(int, int);                       // grow size for per nodes array
