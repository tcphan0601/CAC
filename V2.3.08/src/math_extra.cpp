...
/* ----------------------------------------------------------------------
 Calculate normal vector from 4 point
 ------------------------------------------------------------------------- */

void Normal_vec4(const double P1[3], const double P2[3], 
                 const double P3[3], const double P4[3], double normal[3])
{
  ...
  v2[1] = P3[1]-P2[1];
  v2[2] = P3[2]-P2[2];
  MathExtra::cross3(v1,v2,v);
  MathExtra::norm3(v);
  normal[0] = normal[0] + v[0]/4.0;
  normal[1] = normal[1] + v[1]/4.0;
  normal[2] = normal[2] + v[2]/4.0;
