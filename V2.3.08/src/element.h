...
class Element : protected Pointers {
 public: 
  ...
  int nctypes;           // number of chemical element types (should be equal to atom->ntypes)
  ...
  double ***slip_plane; // normal vector of slip planes in global coordinates (for adapting mesh)
  double ***surface_normvec; // normal vector of element surfaces
  double *ele_rand_amp; // random amplitude of periodic pressure in temppress
  double **ele_surf_area; // area of element surfaces

  double max_size;       // maximum element cubical size (x, y, or z) (for ghost elements)
