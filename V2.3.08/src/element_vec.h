...
class ElementVec : protected Pointers {
 public:
  ...
  virtual void update_surface_normal_vector() = 0;
  virtual void update_ele_surf_area() = 0;
  virtual void update_ele_rand_amp(double, int) = 0;
  ...
  virtual void data_node(int, char **) = 0;
