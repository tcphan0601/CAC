...
private:
  ...
  // 3-body neighbor pair info to calculate 3-body terms when the pair of neighbor are virtual atoms
...
protected:
  ...
  void getscreen(int i, int iindex, double *scrfcn, double *dscrfcn, double *fcpair, int *fmap, 
  ...
  void calc_rho1(int i, int iindex, int *fmap, double *scrfcn, double *fcpair, 
    int numneigh, int *firstneigh, int *firstneighindex);
  ...
  void copy_densities(double *densities, int i, int inode, int iucell, int ibasis);
...
public:
  ...
  void meam_dens_init(int i, int iindex, int *fmap, int fnoffset, 
    int numneigh, int *firstneigh, int *firstneighindex, 
    int numneigh_full, int *firstneigh_full, int *firstneighindex_full);
  ...
  void meam_force(int i, int iindex, int eflag_either, int eflag_global, int eflag_atom, 
