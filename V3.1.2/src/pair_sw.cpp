...
PairSW::PairSW(CAC *cac) : Pair(cac)
{
  ...
  maxshort = 10;
  neighshort = neighindexshort = nullptr;
  rsqshort = nullptr;
  delshort = nullptr;

  nnvamax = 0;
  shortnva_list = shortnva_flag = nullptr;
  ...
  for (ii = 0; ii < numshortnva; ii++) {
    ...
    for (jj = 0; jj < numshort-1; jj++) {
      ...
      for (kk = jj+1; kk < numshort; kk++) {
        ...
        if (fj == nullptr && fk == nullptr) continue;
