...
class Atom : protected Pointers {
 public:
  ...
  void set_charge(const char *, int, const char *, int);
  void set_charge(const char *, int, int, double);
  void set_charge(const char *, int, int, char **);
  void set_charge(double *);
  void check_charge(const char *, int);
