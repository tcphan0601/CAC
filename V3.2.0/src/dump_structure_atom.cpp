...
enum{UNKNOWN_CNA, FCC_CNA, HCP_CNA, BCC_CNA, ICOS_CNA, OTHER_CNA};
...
void DumpStructureAtom::write_atom_data(int n, int size_one, double *mybuf)
{
...
void DumpStructureAtom::write_string(int n, int size_one, double *mybuf)
{
  fwrite(mybuf, sizeof(char), n, fp);
}
/* ------------------------------------------------------------------------------------------------- */

void DumpStructureAtom::write_atom_lines_noimage(int n, int size_one, double *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
    fprintf(fp, format, 
