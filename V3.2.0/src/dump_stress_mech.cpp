...
void DumpStressMech::write_atom_data(int n, int size_one, double *mybuf)
{
...
void DumpStressMech::write_string(int n, int size_one, double *mybuf)
{
  int m;
...
void DumpStressMech::write_surfaces(int n, int size_one, double *mybuf)
{
  int m = 0;
  for (int i = 0; i < n; i++) {
