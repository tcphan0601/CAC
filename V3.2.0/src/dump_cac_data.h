...
class DumpCACData : public Dump {
 ...
 protected:
  ...
  typedef void (DumpCACData:: * FnPtrWrite)(int, int,  double *);
  ...
  void write_elem_lines_noimage(int, int, double *);
  void write_node_lines_noimage(int, int, double *);
  void write_string(int, int, double *);
  void write_atom_lines_reference(int, int, double *);
  void write_elem_lines_reference(int, int, double *);
  void write_node_lines_reference(int, int, double *);
