...
class Dump : protected Pointers {
 ...
 protected:
  ...
  enum{INT, DOUBLE, DOUBLE16, STRING, BIGINT};
  ...
  virtual void write_atom_data(int, int, double *) = 0;
  virtual void write_node_data(int, int, double *) = 0;
  virtual void write_elem_data(int, int, double *) = 0;
