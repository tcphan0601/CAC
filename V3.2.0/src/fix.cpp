...
Fix::Fix(CAC *cac, int narg, char **arg) : 
  ...
  vector_vatom(nullptr), array_vatom(nullptr), vector_local(nullptr), array_local(nullptr), 
  eatom(nullptr), vatom(nullptr), eucell(nullptr), vucell(nullptr)
{
