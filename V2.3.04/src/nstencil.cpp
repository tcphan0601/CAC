...
void NStencil::copy_neighbor_info()
{
  ...
  cutneighmaxelem = cutneighmaxatom + element->max_size;
...
void NStencil::create_setup()
{
  ...
  if (element->nelements) {
    elemsx = static_cast<int> (cutneighmaxelem*elembininvx);
    if (elemsx*elembinsizex < cutneighmaxelem) elemsx++;
    elemsy = static_cast<int> (cutneighmaxelem*elembininvy);
    if (elemsy*elembinsizey < cutneighmaxelem) elemsy++;

    if (dimension == 3) {
      elemsz = static_cast<int> (cutneighmaxelem*elembininvz);
      if (elemsz*elembinsizez < cutneighmaxelem) elemsz++;
    } else elemsz = 0;
